...
export default {
  ...
  atos: {
    ii: "Lo que ya funciona",
    iii: "En construcción",
    iv: "Todavía es idea",
    epilogo: "Epílogo",
  },
  rodar: {
    claquete: "Corre un nodo",
    t1: "No confíes en nosotros.",
    t2: "Corre un nodo.",
    lead: "El programa es de código abierto y ya existe para cuatro sistemas. Guarda la cadena, verifica cada bloque por su cuenta, habla con otros nodos por una conexión cifrada y guarda la billetera cifrada con tu contraseña.",
    p1: "Descarga y verifica la suma SHA-256",
    p2: "Crea la billetera con contraseña",
    p3: "Pon el nodo en línea",
    p4: "Mina en la red de pruebas",
    release: "Versión de prueba publicada · v0.1.0-teste.2",
    celular: "Celular (Termux)",
    nota: "Red de pruebas: el AUR no tiene valor. Los nodos semilla públicos todavía no están en línea; prueba entre dos dispositivos tuyos.",
    guia: "Guía de 5 minutos",
  },
  fim: {
    l1: "No confíes.",
    l2: "Verifica.",
    sub: "Todo número de esta página marcado como “cálculo real” se calculó en tu dispositivo. Lo demás está marcado como ejemplo.",
    rodar: "Correr un nodo",
    codigo: "Leer el código",
  },
  hero: {
    sub: "Una blockchain en la que la prueba de trabajo es un cálculo que sirve, verificado por cualquier computadora.",
    explorar: "Ver cómo funciona",
    assistir: "Ver el filme · voz sintética",
    status: "Red de pruebas · sin venta · sin precio",
    l1: "Cada bloque", l2: "prueba un", l3: "cálculo útil.",
    prova: "Cálculo real, en este dispositivo", role: "desliza",
    prova_valor: "sha512(cabecera v2 · {b} bytes) = {h} · {ms} ms",
  ...
  visao: {
    claquete: "El problema",
    m1: "Billones de cálculos.", m2: "Tirados a la basura.", m3: "El cálculo tiene que servir.",
    l1: "La minería común hace billones de intentos por segundo solo para sortear quién escribe el próximo bloque. Cada línea al lado es un SHA-512 calculado ahora, en tu dispositivo.",
    l2: "Después del sorteo, ninguno de estos números sirve para nada. La energía se vuelve calor y el resultado va a la basura.",
    l3: "En Auron, cada bloque también lleva un producto de matrices derivado del bloque anterior: un cálculo útil que cualquier computadora verifica sin rehacerlo.",
    calculados: "hashes calculados en esta página", uteis: "útiles",
    legenda1: "Cálculo real · 1 línea = 1 SHA-512 · 64 bytes", legenda2: "Matriz 8×8 a partir del último hash · la matriz A de A · B = C",
    olho: "The Vision",
  ...
  nucleo: {
    ...
    partes: {
      blockchain: {
        ...
        itens: ["Un bloque cada 120 segundos, en promedio.", "Cabecera de tamaño fijo: 222 bytes.", "Hash SHA-512 y árbol de Merkle según RFC 6962.", "Transacciones con varios activos y hasta 16 destinatarios."],
      },
      nos: {
        ...
        itens: ["Programa de producción en Rust puro, sin código en C, para funcionar en celulares y en cualquier computadora.", "Comunicación entre nodos por internet sobre TCP. El cifrado Noise está en implementación.", "La sincronización, la propagación de bloques, el descubrimiento de pares y la recuperación automática ya funcionan en las pruebas."],
      },
      consenso: {
  ...
  mentira: {
    claquete: "Trabajo útil",
    m1: "A · B = C.", m2: "Sortea r.", m3: "Compara los dos lados.", m4: "Barato. Muy barato.", m5: "Ahora, miente.",
    l1: "Alguien entrega C y dice que multiplicó A por B. Rehacer todo el cálculo es caro. ¿Cómo saber si es verdad?",
    l2: "El verificador saca un vector r del SHA-512 del propio resultado. Quien hizo el cálculo no conoce r antes de entregar C.",
    l3: "Calcula A · (B · r) y C · r. Son solo productos de matriz por vector. Si C es correcto, las ocho filas coinciden.",
    l4: "En una matriz 8×8, verificar en 3 rondas cuesta <b>576</b> multiplicaciones y rehacer cuesta <b>512</b>: aquí sale más caro. En 1000×1000 son <b>9 millones</b> contra <b>1000 millones</b>.",
    l5: "Toca cualquier número de C para cambiar el resultado. La verificación vuelve a correr, con un r nuevo, y señala la fila errónea.",
    refazer: "Nueva tarea honesta",
    nota: "En una ronda, una mentira pasa con probabilidad de como máximo 1 en 97 en esta demostración. El consenso de Auron usa 4 rondas de 20 bits: como máximo 1 en 2⁸⁰.",
    real: "Cálculo real · Freivalds en tu dispositivo · matrices de ejemplo",
    celula: "C, fila {l}, columna {c}: {v}. Cambiar este número",
    aceito: "Aceptado · {k} rondas coinciden · pago liberado",
    recusado: "Rechazado · la fila {l} no coincide en la ronda {k} · pago: 0",
  },
  utrax: {
  ...
  seg: {
    ...
    mecanismos: [
      ...
      ["Nonce", "Cada cuenta tiene una secuencia: la misma transacción no cuenta dos veces.", "implementado"],
      ["Protección contra repetición", "La firma incluye el identificador de la red: no se puede reutilizar en otra.", "implementado"],
      ["Separación de dominios", "Cada firma declara para qué sirve (AURON-TX-v2, UTRAX…).", "implementado"],
      ["Verificación de trabajo", "Freivalds comprueba matrices sin rehacer el cálculo.", "implementado"],
  ...
  onde: {
    ...
    intro: "Estado al 13/09/2026. Esta sección existe para que nadie confunda una visión con un producto terminado.",
    colunas: {
      live: { titulo: "Implementado", itens: [["Programa de producción (Rust)", "cadena, consenso, minería y red; 80 pruebas"], ["Especificación AURON-SPEC-01", "reglas byte a byte"], ["6 correcciones de seguridad", "de la revisión del 11/09/2026, con una prueba por ataque"], ["Referencia en Python", "completa, con trabajo útil en cada bloque; 122 pruebas"]] },
      building: { titulo: "En desarrollo", itens: [["Cifrado de la conexión", "Noise entre los nodos"], ["Billetera con contraseña", "clave protegida en el archivo"], ["UTRAX", "prototipo con tres tipos de tarea"], ["Red de pruebas pública", "prevista para diciembre de 2026"]] },
      research: { titulo: "Investigación", itens: [["Fragmentación 16×16", "modelo lógico"], ["Transporte por radio", "idea experimental"], ["Almacenamiento distribuido", "con redundancia"], ["Problemas reales dentro del bloque", "pregunta abierta"]] },
      future: { titulo: "Futuro", itens: [["Red principal", "solo después de la red de pruebas pública"], ["Auron Direct y Resonance", "arquitectura escrita"], ["IA y economía de máquinas", "visión"], ["Auron Flux", "solo con autorización del banco central"]] },
    },
  ...
  aberto: {
    ...
    roteiro: "Guion del video", "roteiro-d": "Las diez escenas de la presentación, para grabar o generar un video. En portugués.", "baixar-roteiro": "Descargar el guion",
    github: "El código también está en GitHub, con las pruebas ejecutándose en cada cambio.", "github-link": "Abrir en GitHub",
    arquivos: "{n} archivos",
  ...
  edit: {
    ...
    cenas: [
      ...
      },
      {
        ...
        fala: "Cada regla se escribe en la especificación y se implementa dos veces: una referencia en Python y el programa de producción en Rust puro. Los dos deben aceptar y rechazar exactamente lo mismo, byte a byte. Ciento veintidós pruebas en la referencia y ochenta en Rust, y los seis fallos de la revisión de ataques ya están corregidos.",
      },
      {
