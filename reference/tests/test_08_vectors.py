...
Os casos de borda de verificacao Ed25519 foram gerados pelo oraculo. Aqui eles
sao conferidos de novo contra o oraculo de agora: se alguem mudar a regra de
verificacao no Python sem regerar os vetores, este teste acusa.
"""
...
def test_manifest_matches_files():
    ...
    assert len(files) >= 12, f"poucos arquivos no manifesto: {len(files)}"
